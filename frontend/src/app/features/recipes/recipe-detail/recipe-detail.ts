...
export class RecipeDetailComponent implements OnInit {
  ...
  onAnalyze() {
    ...
    const prompt = `Analysez les valeurs nutritionnelles de cette recette en utilisant la base de données CIQUAL comme référence. `
                   ...
                   +`"calories": <nombre>, "protein": <nombre en g>, "carbs": <nombre en g>, "fat": <nombre en g>, "fiber": <nombre en g>,`
                   +` "sugar": <nombre en g>, "sodium": <nombre en mg>, "vitamins": {"vitaminA": <nombre en µg>, "vitaminC": <nombre en mg>, ...},`
                   +`"minerals": {"calcium": <nombre en mg>,  ...}}`;
